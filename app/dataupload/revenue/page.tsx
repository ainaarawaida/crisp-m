...
const Example = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<User>[]>(
    () => [
      ...
      {
        accessorKey: 'operating_income',
        header: 'operating_income',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.operating_income,
          helperText: validationErrors?.operating_income,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'utilisation_of_grant',
        header: 'utilisation_of_grant',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.utilisation_of_grant,
          helperText: validationErrors?.utilisation_of_grant,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              utilisation_of_grant: undefined,
            }),
        },
      },
      {
        accessorKey: 'finance_income',
        header: 'finance_income',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.finance_income,
          helperText: validationErrors?.finance_income,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              finance_income: undefined,
            }),
        },
      },
      {
        accessorKey: 'securitisation_income',
        header: 'securitisation_income',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.securitisation_income,
          helperText: validationErrors?.securitisation_income,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              securitisation_income: undefined,
            }),
        },
      },
      {
        ...
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.other_income,
          helperText: validationErrors?.other_income,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'budgeted_revenue',
        header: 'budgeted_revenue',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.budgeted_revenue,
          helperText: validationErrors?.budgeted_revenue,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              budgeted_revenue: undefined,
            }),
        },
      },
    ],
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/revenue`, {
          method: "POST",
...
function useGetUsers() {
  return useQuery<User[]>({
    ...
    queryFn: async () => {
      try {
        const response  = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/revenue`);
        const data = await response.json();
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        // let dataArray = new FormData();
        // dataArray.append("User[clientId]", "lppsa");
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/revenue/${user.year_month}`, {
          method: "POST",
          body: JSON.stringify(user),
        });
  ...
  return useMutation({
    mutationFn: async (userId: string) => {
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/revenue/${userId}`, {
          method: "DELETE",
        });
