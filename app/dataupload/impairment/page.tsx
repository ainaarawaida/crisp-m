...
const Example = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<User>[]>(
    () => [
      ...
      {
        accessorKey: 'impairment',
        header: 'impairment',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.impairment,
          helperText: validationErrors?.impairment,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'budgeted_impairment',
        header: 'budgeted_impairment',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.budgeted_impairment,
          helperText: validationErrors?.budgeted_impairment,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              budgeted_impairment: undefined,
            }),
        },
      },
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/impairment`, {
          method: "POST",
...
function useGetUsers() {
  return useQuery<User[]>({
    ...
    queryFn: async () => {
      try {
        const response  = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/impairment`);
        const data = await response.json();
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        // let dataArray = new FormData();
        // dataArray.append("User[clientId]", "lppsa");
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/impairment/${user.year_month}`, {
          method: "POST",
          body: JSON.stringify(user),
        });
  ...
  return useMutation({
    mutationFn: async (userId: string) => {
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/impairment/${userId}`, {
          method: "DELETE",
        });
