  ...
  const columns = useMemo<MRT_ColumnDef<User>[]>(
    () => [
      ...
      },
      {
        ...
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.total_assets,
          helperText: validationErrors?.total_assets,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'cash_and_cash_equivalent',
        header: 'cash_and_cash_equivalent',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.cash_and_cash_equivalent,
          helperText: validationErrors?.cash_and_cash_equivalent,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              cash_and_cash_equivalent: undefined,
            }),
        },
      },
      {
        ...
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.investment,
          helperText: validationErrors?.investment,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'home_financing',
        header: 'home_financing',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.home_financing,
          helperText: validationErrors?.home_financing,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              home_financing: undefined,
            }),
        },
      },
      {
        accessorKey: 'other_receivables',
        header: 'other_receivables',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.other_receivables,
          helperText: validationErrors?.other_receivables,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              other_receivables: undefined,
            }),
        },
      },
      {
        accessorKey: 'property_and_equipment',
        header: 'property_and_equipment',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.property_and_equipment,
          helperText: validationErrors?.property_and_equipment,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              property_and_equipment: undefined,
            }),
        },
      },
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/assets`, {
          method: "POST",
...
function useGetUsers() {
  return useQuery<User[]>({
    ...
    queryFn: async () => {
      try {
        const response  = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/assets`);
        const data = await response.json();
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        // let dataArray = new FormData();
        // dataArray.append("User[clientId]", "lppsa");
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/assets/${user.year_month}`, {
          method: "POST",
          body: JSON.stringify(user),
        });
  ...
  return useMutation({
    mutationFn: async (userId: string) => {
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/assets/${userId}`, {
          method: "DELETE",
        });
