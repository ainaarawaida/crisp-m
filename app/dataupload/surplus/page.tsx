  ...
  const columns = useMemo<MRT_ColumnDef<User>[]>(
    () => [
      ...
      },
      {
        ...
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.surplus,
          helperText: validationErrors?.surplus,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'budgeted_surplus',
        header: 'budgeted_surplus',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.budgeted_surplus,
          helperText: validationErrors?.budgeted_surplus,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              budgeted_surplus: undefined,
            }),
        },
      },
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/surplus`, {
          method: "POST",
...
function useGetUsers() {
  return useQuery<User[]>({
    ...
    queryFn: async () => {
      try {
        const response  = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/surplus`);
        const data = await response.json();
  ...
  return useMutation({
    mutationFn: async (user: User) => {
      ...
      try {
        // let dataArray = new FormData();
        // dataArray.append("User[clientId]", "lppsa");
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/surplus/${user.year_month}`, {
          method: "POST",
          body: JSON.stringify(user),
        });
  ...
  return useMutation({
    mutationFn: async (userId: string) => {
      try {
        ...
        let response = await fetch(`${process.env.NEXT_PUBLIC_BASEPATH_URL}/api/data/surplus/${userId}`, {
          method: "DELETE",
        });
