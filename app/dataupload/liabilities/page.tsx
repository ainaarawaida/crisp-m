...
const Example = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<User>[]>(
    () => [
      ...
      {
        accessorKey: 'total_liabilities',
        header: 'total_liabilities',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.total_liabilities,
          helperText: validationErrors?.total_liabilities,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'borrowings',
        header: 'borrowings',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.borrowings,
          helperText: validationErrors?.borrowings,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
      ...
      {
        accessorKey: 'other_payables',
        header: 'other_payables',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.other_payables,
          helperText: validationErrors?.other_payables,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
              other_payables: undefined,
            }),
        },
      },
      {
        accessorKey: 'other_liabilities',
        header: 'other_liabilities',
        muiEditTextFieldProps: {
          required: false,
          error: !!validationErrors?.other_liabilities,
          helperText: validationErrors?.other_liabilities,
          //remove any previous validation errors when user focuses on the input
          onFocus: () =>
            setValidationErrors({
              ...validationErrors,
